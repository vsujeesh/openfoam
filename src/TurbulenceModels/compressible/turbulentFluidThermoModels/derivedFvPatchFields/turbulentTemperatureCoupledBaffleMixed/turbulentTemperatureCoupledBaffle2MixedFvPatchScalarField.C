...
#include "turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField.H"
...
turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField::
turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField
(
    const fvPatch& p,
...
turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField
(
    const turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField
(
    const turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField& wtcsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
...
void turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
//    // ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
//    const turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField& nbrField =
//    refCast
//    <
//        const turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField
//    >
//    (
...
void turbulentTemperatureCoupledBaffle2MixedFvPatchScalarField::write
(
    Ostream& os
) const
{
